...
const timerContainer = document.getElementsByClassName("timerContainer0")[0];
...
function clockRunning(){
 ...
 document.getElementById("timerDisplay").innerHTML =(minutes = minutes < 10 ? '0' +minutes:minutes )+ ":"+(seconds = seconds<10 ? '0' +seconds:seconds ) + ":" + (milliseconds = milliseconds<10 ? '0' +milliseconds:milliseconds); 
